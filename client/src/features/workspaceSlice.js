...
const workspaceSlice = createSlice({
    ...
    reducers: {
        ...
        updateProjects: (state, action) => {
            ...
            // Update project in workspaces list
            state.workspaces = state.workspaces.map((w) => {
...
export const { setWorkspaces, setCurrentWorkspace, addWorkspace, updateWorkspace, deleteWorkspace, addProject, updateProjects, addTask, updateTask, deleteTask } = workspaceSlice.actions;
